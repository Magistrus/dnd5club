...
public class FSkills {
	...
	public FSkills(List<Skill> skills) {
		...
		if (skillMap.containsKey(SkillType.HISTORY)) {
			his.setValue((byte) 1);
			his.setMod(skillMap.get(SkillType.HISTORY));
		}
		his.setAbility("int");
		...
		if (skillMap.containsKey(SkillType.PERCEPTION)) {
			prc.setValue((byte) 1);
			prc.setMod(skillMap.get(SkillType.PERCEPTION));
		}
		prc.setAbility("wis");
		...
		if (skillMap.containsKey(SkillType.PERFORMANCE)) {
			prf.setValue((byte) 1);
			prf.setMod(skillMap.get(SkillType.PERFORMANCE));
		}
		prf.setAbility("cha");
		...
		if (skillMap.containsKey(SkillType.PERSUASION)) {
			per.setValue((byte) 1);
			per.setMod(skillMap.get(SkillType.PERSUASION));
		}
		per.setAbility("cha");
