    ...
    actions: {
        ...
        async godsQuery(options = {}) {
            try {
                ...
                const { data } = await http.post(this.config.url, apiOptions, this.controllers.godsQuery.signal);
        ...
        async godInfoQuery(url) {
            try {
                ...
                const resp = await http.post(url, {}, this.controllers.godInfoQuery.signal);
